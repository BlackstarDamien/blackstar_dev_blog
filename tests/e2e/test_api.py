...
def test_articles_endpoint_returns_200_and_all_articles():
...
@pytest.mark.usefixtures("postgres_session")
def test_article_endpoint_returns_200_and_specified_article():
    post_to_add_article("Async Libraries in Python", "Tom Smith", "2022-01-01", "Some async libs", "Lorem ipsum...")
...
@pytest.mark.usefixtures("postgres_session")
def test_article_endpoint_returns_404_and_specified_article():
...
@pytest.mark.usefixtures("postgres_session")
def test_article_should_return_400_and_error_message():
